		...
		<div className="pageContent">
			<div className="page-container pl-12 pr-12 md:pl-36 md:pr-36 lg:pl-48 lg:pr-48 xl:pl-52 xl:pr-52">
				<main className="content-wrap">
					<div className="flex w-full mb-8" data-aos="fade-right">
					...
					<div
						className="latestNews grid grid-cols-1 2xl:grid-cols-2 gap-8 text-white"
						data-aos="fade-up"
					>
						{/* Big Cover */}
						<div
					...
					<div className="flex w-full mt-24 mb-12" data-aos="fade-up">
					...
					<div
						className="loadMoreDiv mt-16 mb-8 text-center text-white w-full"
						data-aos="fade-up"
					>
						<button
							type="button"
